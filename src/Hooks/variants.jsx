...
export const variants3 = createVariants(
  // Evalúa si el dispositivo es móvil y usa las propiedades adecuadas para el estado "hidden"
  isMobile()
    ? {
        opacity: 0, // Opacidad inicial (invisible)
        x: -50, // Desplazamiento horizontal inicial (10px a la izquierda)
        scale: 0.1, // Escala inicial (10% del tamaño original)
        rotate: 0, // Sin rotación inicial
      }
    : {
        opacity: 0, // Opacidad inicial (invisible)
        x: -400, // Desplazamiento horizontal inicial (500px a la izquierda)
        scale: 0.1, // Escala inicial (10% del tamaño original)
        rotate: 0, // Sin rotación inicial
      },
