...
<div className='relative h-screen overflow-hidden'>
  ...
  >
    <div className='absolute inset-0 flex md:justify-start bg-opacity-35 xs:justify-center xs:my-28 md:my-0 bg-reno-900'>
      <div className='bg-reno-950 bg-opacity-90 md:w-1/2 flex flex-col md:justify-center items-center xs:mx-3 md:mx-0 xs:px-3 xs:pb-2 gap-10 xs:rounded-3xl md:rounded-none'>
        <div className='bg-white flex justify-center overflow-hidden rounded-full border-4 border-reno-400 shadow-reno-100 mb-4 md:mt-28 xs:mt-4'>
          <img src={imagenJuani} alt="Foto de Juan Ignacio Andrada Cabo" className='object-contain h-40 w-40 md:h-60 md:w-60 xs:h-auto xs:w-auto'/>
        </div>
        <div>
