      ...
      <footer className="text-reno-50 bg-reno-900 px-4 py-5 mx-auto md:px-8">
        <div className="max-w-lg xs:mx-auto xs:text-justify xs:px-8">
          <img
            alt="logoJuani"
            src={logoJuani}
            className="w-20 xs:mx-auto bg-white pl-2 rounded-xl"
          />
          <p className="leading-relaxed mt-2 text-[15px] xs:mt-4">
            ¡Muchas gracias por revisar mi portfolio! Si tienes alguna pregunta
            o comentario, no dudes en ponerte en contacto conmigo.
          </p>
        </div>
          ...
          <div className="mt-6 xs:mt-0">
            <ul className="flex items-center space-x-4">
              {icons.map((item, idx) => (
                <li
                  key={idx}
                  className="w-10 h-10 border rounded-full flex items-center justify-center hover:text-reno-600 hover:bg-blue-100 transition duration-500"
                >
