  ...
  return (
    <div id='about' className='md:min-h-screen xs:min-h-0 bg-reno-700 relative'>
      <div className='flex md:justify-start xs:justify-center items-center h-32 bg-gradient-to-l from-reno-950 to-reno-800'> 
        <span className='text-4xl mt-4 md:ml-5 xs:my-2 font-semibold text-white'>Acerca de mi</span>
      </div>
      ...
      <div className='grid md:grid-cols-2 lg:grid-cols-3 xs:grid-cols-1 gap-8 relative z-10 justify-center items-center xs:mt-6 md:mt-4 lg:mt-0'>
        ...
        <div className="md:col-span-2 lg:col-span-3 bg-reno-600 mx-4 md:mx-8 rounded-lg shadow-lg p-6 xs:mb-10 md:mb-10 lg:mb-10 lg:mx-64">
          ...
          <div className='flex justify-center flex-wrap gap-6 text-center'>
            ...
            <div className='bg-white rounded-lg shadow-md xl:w-1/3 md:w-3/5 xs:w-3/4 p-2'>
              <h3 className='text-reno-900 text-lg md:text-xl font-semibold mb-4'>Backend Developer</h3>
              <img src={backend} alt="imagenBackend" className='w-40 h-40 mx-auto'/>
            </div>
            <div className='bg-white rounded-lg shadow-md xl:w-1/3 md:w-3/5 xs:w-3/4 p-2'>
              <h3 className='text-reno-900 text-lg md:text-xl font-semibold mb-4'>Frontend Developer</h3>
      ...
      <div className="absolute bottom-0 left-0 w-full h-full z-0">
        <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-reno-900 to-reno-800" style={{ clipPath: 'polygon(100% 19%, 100% 100%, 0 100%, 0 81%)'}}>
        </div>
      </div>
    </div>
  );
