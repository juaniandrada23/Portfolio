  ...
  return (
    <div id='xp' className='w-full'>
      ...
      <div className='flex justify-center items-center flex-col bg-gradient-to-t from-gray-900 to-gray-800'>
        <div className='bg-reno-900 p-4 m-5 rounded-r-3xl rounded-es-3xl shadow-md shadow-black hover:shadow-md hover:shadow-reno-700 transition duration-200 delay-75 ease-in'>
