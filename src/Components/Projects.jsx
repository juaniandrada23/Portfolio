...
const projectsData = [
  {
    ...
    description: "Simplifica el seguimiento de gastos e ingresos con proveedores...",
  ...
  },
  {
    ...
    description: "Trabajo realizado sobre la generación de variables aleatorias...",
    ...
    <div className="md:my-16 xs:my-10 xs:mx-2 md:mx-0 flex justify-center items-center gap-10 md:flex-row xs:flex-col">
      <div className="grid xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {projectsData.map((project, idx) => (
          <motion.div key={idx} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }}
            variants={{
              hidden: { opacity: 0, y: 100 },
              visible: { opacity: 1, y: 0, transition: { duration: 0.5 } }
            }}>
            <Card sx={{ maxWidth: 385, boxShadow: '0px 5px 20px black', backgroundColor: '#2c406d' }} className="m-2 flex flex-col justify-between">
              <CardActionArea>
