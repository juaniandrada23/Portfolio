        ...
        <Toolbar style={{ display: "flex", justifyContent: "space-between" }}>
          <div className="bg-white rounded-full xs:my-4 md:my-3">
            <img
              src={logoJuani}
              alt="Logo"
              className="md:w-8 md:h-8 xs:w-8 xs:h-8 m-2"
            />
          </div>
          ...
          {!isMobile && (
            <div>
              <button
                className="flex justify-center items-center bg-white p-2 rounded-full text-reno-900 hover:text-white hover:bg-reno-500 transition duration-500"
                onClick={handleDrawerOpenMax}
              >
                        ...
                        >
                          <Button
                            ...
                            style={{
                              ...
                              boxShadow: "0px 15px 15px -15px rgba(0, 0, 0, 1)",
                            }}
                            onClick={handleDrawerCloseMax}
                          >
                            <HomeIcon
                              sx={{ fontSize: "6vh" }}
                              className="text-reno-900"
                            />
                          </Button>
                        </Link>
                      </ListItem>
                    ...
                    <div className="gap-8 border-l-4 border-reno-300 ml-2 flex justify-center flex-col">
                      <ListItem className="mt-4">
                        ...
                        >
                          <label
                            onClick={handleDrawerCloseMax}
                            className="text-3xl font-bold bg-left-bottom bg-gradient-to-r from-reno-200 to-reno-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_3px] pb-2 transition-all duration-500 ease-out"
                          >
                            ACERCA DE MI
                          </label>
                        </Link>
                      ...
                      <ListItem>
                        ...
                        >
                          <label
                            onClick={handleDrawerCloseMax}
                            className="text-3xl font-bold bg-left-bottom bg-gradient-to-r from-reno-200 to-reno-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_3px] pb-2 transition-all duration-500 ease-out uppercase"
                          >
                            tecnologías
                          </label>
                        </Link>
      ...
      <Drawer anchor="right" open={drawerOpen} onClose={handleDrawerClose}>
        ...
        >
          ...
          <div className="border-l-4 border-reno-300 ml-2">
            ...
            <ListItem>
              <Link to="proyect" smooth={true} duration={500} offset={-80}>
                <label
                  onClick={handleDrawerClose}
                  style={{ fontWeight: "bold" }}
                >
